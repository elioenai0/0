...
elementoA.addEventListener('click',function(){
    var caminho = 'musica_aula1.html'
    var win = window.open(caminho, '_self');
    win.focus();
})

function block(){
    window.alert("Mensagem da equipe Tutoring: infelizmente essa página ou curso ainda não existe. Estamos trabalhando para disponibilizar o melhor para você. Apoie-nos! Doe!")
}
